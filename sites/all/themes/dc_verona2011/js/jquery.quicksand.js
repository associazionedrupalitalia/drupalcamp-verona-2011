...
(function ($) {
    $.fn.quicksand = function (collection, customOptions) {     
        ...
        return this.each(function (i) {
			...
			count_li = $(".filter_count").attr('data-rel');
			
			
			$dest.append($collection).find("li").removeClass("last")
			$dest.append($collection).find("li:nth-child("+count_li+"n)").addClass("last")
            $dest.append($collection).find("li:nth-child("+count_li+"n+1)").prev().after('<div class="cleardiv"></div>');      
